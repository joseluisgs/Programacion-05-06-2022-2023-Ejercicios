...
internal class RepositoryMapTest {
    @BeforeEach
    fun inicio() {
        repositorio = RepositoryMap()
    }
    var repositorio = RepositoryMap()
    var listaTest = mutableMapOf(
    ...
    fun pacientesOrdenadosFechaIngreso() {
        ...
        var listaOrdendaTest =mutableMapOf(
            "53454692F" to Paciente(
                dni = "53454692F",
                nombre = "Oscar Gracia ",
                fechaNacimiento = "1986-06-22",
    ...
    fun pacientesPorTipo() {
        ...
        var listaFiltradaTest =mutableMapOf(
            "53454692F" to Paciente(
                dni = "53454692F",
                nombre = "Oscar Gracia ",
                fechaNacimiento = "1986-06-22",
    ...
    fun borrarpaciente() {
        ...
        var listaDespuesBorradoTest =mutableMapOf(
            "53454692F" to Paciente(
                dni = "53454692F",
                nombre = "Oscar Gracia ",
                fechaNacimiento = "1986-06-22",
