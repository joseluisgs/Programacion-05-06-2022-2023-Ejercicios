...
class HospitalListaRepositoryTest {

    private lateinit var repo: HospitalListaRepository
    private lateinit var repoLleno: HospitalListaRepository
    ...
    @BeforeEach
    fun setUp() {
        repo = HospitalListaRepository(1)
        repoLleno = HospitalListaRepository(2)
