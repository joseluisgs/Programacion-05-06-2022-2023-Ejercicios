...
class HospitalRepositoryMapaTest {
    private lateinit var hospital: HospitalRepositoryMapa
    private lateinit var hospitalVacio: HospitalRepositoryMapa
    ...
    @BeforeEach
    fun setUp() {
        hospital = HospitalRepositoryMapa(3)
        hospitalVacio = HospitalRepositoryMapa(3)
