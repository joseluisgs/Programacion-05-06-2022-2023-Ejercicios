...
class HospitalRepositoryConjuntoTest {
    private lateinit var hospital: HospitalRepositoryConjunto
    private lateinit var hospitalVacio: HospitalRepositoryConjunto
    ...
    @BeforeEach
    fun setUp() {
        hospital = HospitalRepositoryConjunto(3)
        hospitalVacio = HospitalRepositoryConjunto(3)
